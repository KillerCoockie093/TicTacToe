...
public class ZEICHENFENSTER implements MouseListener, MouseMotionListener
{
    ...
    private ZEICHENFENSTER(String titel, int breite, int hoehe, Color hintergrundFarbe)
    {
        ...
        frame.pack();
        frame.setResizable(false);          //premium
        frame.setLocationRelativeTo(null); //premium +
        frame.setVisible(true);           //premium ++
        zeige();
    }
    ...
    public static ZEICHENFENSTER gibFenster()
    {
        if (singleton==null)
        {
            singleton = new ZEICHENFENSTER("Tic-Tac-Toe");
        }
        singleton.zeige();
        return singleton;
    }
